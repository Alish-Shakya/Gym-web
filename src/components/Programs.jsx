      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            {
              title: "Zumba",
              desc: "Dance your way to fitness with energetic and fun Zumba classes that burn calories while you enjoy.",
              img: "https://images.unsplash.com/photo-1605296867424-35fc25c9212e",
            },
            {
              title: "Cardio",
              desc: "Boost your endurance and heart health with high-energy cardio workouts tailored to all fitness levels.",
              img: "https://images.unsplash.com/photo-1605296867818-2f9b6d7ab5a1",
            },
            {
              title: "Gym",
              desc: "Access top-of-the-line gym equipment and professional trainers to help you achieve your fitness goals.",
              img: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b",
            },
          ].map((p, i) => (
            <div
              key={i}
              className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center text-center hover:shadow-2xl hover:-translate-y-2 transition"
            >
              <img
                src={p.img}
                alt={p.title}
