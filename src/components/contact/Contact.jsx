...
Have questions or need guidance? Our trainers are here to support you every step of the way. Reach out and start transforming your body today!
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-8 text-left">
          ...
          <div className="bg-yellow-50 p-6 rounded-xl shadow hover:shadow-yellow-200 transition">
            ...
            <a href="mailto:info@vyomite.com.np" className="text-yellow-600 hover:underline">
          ...
          <div className="bg-yellow-50 p-6 rounded-xl shadow hover:shadow-yellow-200 transition">
            ...
            <a href="tel:+9779813453246" className="text-yellow-600 hover:underline">
              +977 9761814913
            </a>
          </div>
          ...
          <div className="bg-yellow-50 p-6 rounded-xl shadow hover:shadow-yellow-200 transition">
            ...
            <p className="text-gray-600 text-sm mb-3">Connect with Us on Social Media:</p>
